...
vim.api.nvim_create_autocmd("BufWritePost", { command = "source <afile> | PackerSync", group = packer_group, pattern = 'lua/plugins.lua' })
...
return packer.startup({
	function(use)
		...
		require("config.neogen-nvim").init(use) -- Doc comments generator
